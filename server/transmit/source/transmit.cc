...
DEFINE_string(instance_service,"/transmit_service/instance","当前实例名称");
DEFINE_string(access_host,"http://127.0.0.1:10004","外部访问地址");
...
int main(int argc, char *argv[])
{
    ...
    fsb.make_discovery_client(FLAGS_etcd_host,FLAGS_basename_service,FLAGS_user_service);
